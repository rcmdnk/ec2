...
AMI_ENABLE_SWAP=${AMI_ENABLE_SWAP-1}
AMI_ENABLE_PACKAGES=${AMI_ENABLE_PACKAGES-1}
AMI_ENABLE_TIMEZONE=${AMI_ENABLE_TIMEZONE-1}
AMI_ENABLE_IDLE_SHUTDOWN=${AMI_ENABLE_IDLE_SHUTDOWN-1}
validate_bool AMI_ENABLE_SWAP "$AMI_ENABLE_SWAP"
validate_bool AMI_ENABLE_PACKAGES "$AMI_ENABLE_PACKAGES"
validate_bool AMI_ENABLE_TIMEZONE "$AMI_ENABLE_TIMEZONE"
...
INSTANCE_COPY_FILES=${INSTANCE_COPY_FILES-}
INSTANCE_COPY_DESTINATIONS=${INSTANCE_COPY_DESTINATIONS-}
INSTANCE_COPY_PERMISSIONS=${INSTANCE_COPY_PERMISSIONS-}
